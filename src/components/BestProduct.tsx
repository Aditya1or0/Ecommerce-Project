...
const BestProduct: React.FC = () => {
  ...
  return (
    <>
      <h1 className=' text-center mt-10 mb-4 font-bold text-gray-700 text-3xl'>Best <span className='text-cyan-600 '>Products</span></h1>
      <p className='text-center text-gray-600 text-md'>Our Best Products that have rating above 4</p>
      ...
      {filteredProducts.length > 0 ? (
        filteredProducts.map((product) => (
          <Link to={`/products/${product.id}`} key={product.id}>
            <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white/70">
              <img
