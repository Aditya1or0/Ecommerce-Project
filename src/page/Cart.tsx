  ...
  if (cartItems.length === 0) {
    return (
      <div className="text-center text-xl py-20">
        ...
        <Link to="/products" className="text-cyan-600 font-bold">Go to Products</Link>
      </div>
    );
  }
    ...
    <div className="container mx-auto my-10">
      ...
      <div className="flex justify-between items-center mt-6">
        ...
        <div className="font-semibold text-lg">
          Total: ₹{cartItems.reduce((total: any, item: { price: any; quantity: any; }) => total + item.price * item.quantity, 0)}
        </div>
        <Link
          to="/checkout"
